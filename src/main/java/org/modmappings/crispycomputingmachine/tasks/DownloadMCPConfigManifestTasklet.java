...
@Component
public class DownloadMCPConfigManifestTasklet implements Tasklet, InitializingBean {
    ...
    public RepeatStatus execute(final StepContribution contribution, final ChunkContext chunkContext) throws Exception {
        ...
        Utils.downloadFile(manifestFile.toPath(), Constants.MCP_CONFIG_MAVEN_METADATA_URL, "mcpconfig-maven");
